...
async def main():
    ...
    parser.add_argument('--skip-kernel', action='store_true', help='Skip kernel eBPF uprobe tests')
    parser.add_argument('--test-iter', type=int, default=100000, help='Inner iterations passed to benchmark/test (default: 100000)')
    ...
    run_kernel = False if args.skip_kernel else ensure_sudo()
