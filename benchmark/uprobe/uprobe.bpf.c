...
/*
 * Disabled for the ARM64 QEMU benchmark VM: this kernel does not expose
 * bpf_probe_write_user to kprobe/uprobe programs, so leaving this program in
 * the object makes the whole skeleton fail verification.
 */
#if 0
